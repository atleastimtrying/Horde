(function() {
  ...
  window.Input = (function() {
    ...
    Input.prototype.keyPressDown = function(event) {
      var message;
      if (event.keyCode === 87) message = 'up';
      if (event.keyCode === 83) message = 'down';
      if (event.keyCode === 65) message = 'left';
      if (event.keyCode === 68) message = 'right';
      if (event.keyCode === 66) message = 'bomb';
      if (event.keyCode === 32) message = 'pause';
    ...
    Input.prototype.clicked = function(event) {
      var message;
      if (event.which === 1) message = 'leftclick';
      if (event.which === 3) message = 'rightclick';
