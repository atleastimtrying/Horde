(function() {
  ...
  window.LocalPlayer = (function() {
    ...
    LocalPlayer.prototype.key = function(event, data) {
      this.keyDown = true;
      if (data === 'up') this.instructions = [0, -1];
      if (data === 'down') this.instructions = [0, 1];
      if (data === 'left') this.instructions = [-1, 0];
      if (data === 'right') return this.instructions = [1, 0];
    };
